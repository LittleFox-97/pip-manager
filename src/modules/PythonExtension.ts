...
import type { ExtensionContextType } from '@/interface'
...
export const PythonExtensionDecorator = createDecorator<IPythonExtension>('pythonExtension')
...
export class PythonExtension implements IPythonExtension {
  ...
  static Create(instantiation: InstantiationService, service?: ServiceCollection) {
    ...
    if (service) {
      service.set(PythonExtensionDecorator, instance)
    }
    return instance
  }
