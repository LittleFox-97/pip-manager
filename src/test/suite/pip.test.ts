...
import type { PackageManager } from '@/modules/PackageManager'
...
suite('Extension Pip Test Suite', function () {
  ...
  it('pip api: create package info', () => {
